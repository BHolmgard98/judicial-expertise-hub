...
const statusItems = [
  ...
  { title: "Realizar Perícia", url: "/dashboard/aguardando-pericia", icon: Clock, status: "AGUARDANDO PERÍCIA", showCount: true },
  { title: "Entregar Laudo", url: "/dashboard/aguardando-laudo", icon: FileText, status: "AGUARDANDO LAUDO", showCount: true },
  { title: "Entregar Esclarecimento", url: "/dashboard/aguardando-esclarecimentos", icon: FileText, status: "AGUARDANDO ESCLARECIMENTOS", showCount: true },
